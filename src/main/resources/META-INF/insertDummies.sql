...
INSERT INTO Advertentie  (id, titel, omschrijving, categorie_id, subCategorie_id, aanbieder_id) VALUES (1, 'kite North 9m', 'north kite nooit gebruikt',1 , 2, 1);
INSERT INTO Advertentie  (id, titel, omschrijving, categorie_id, subCategorie_id, aanbieder_id) VALUES (2, 'kite board','f1 kite board zo goed als nieuw',1, 3, 2);
INSERT INTO Advertentie  (id, titel, omschrijving, categorie_id, subCategorie_id, aanbieder_id) VALUES (3, 'kite North 12m','north kite 12m geel',1, 2, 3);